...
void
create_index_table(const unsigned char* p1, unsigned char* p2)
{
...
void
create_pattern16x16(const unsigned char* pattern4x4,
	unsigned char* pattern16x16)
{
...
void
print_pattern(ostream& os, const char* name, const unsigned char* pattern)
{
