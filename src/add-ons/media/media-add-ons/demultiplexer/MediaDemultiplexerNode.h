...
// the output.
#ifndef _MEDIA_DEMULTIPLEXER_NODE_H
...
class MediaDemultiplexerNode : public BBufferConsumer, public BBufferProducer,
	public BMediaEventLooper {
protected:
	virtual ~MediaDemultiplexerNode();

public:
	explicit MediaDemultiplexerNode(const flavor_info* info = NULL, BMessage* config = NULL,
...
protected:
	...
	virtual	void AdditionalBufferRequested(
					...
					bigtime_t prev_time,
					const media_seek_tag* prev_tag = NULL);
...
private:
		...
		media_input fInput;
		BObjectList<MediaOutputInfo> fOutputs;
