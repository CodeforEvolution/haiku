...
public:
			...
			DriverSpecificSettings	&operator=(
										const DriverSpecificSettings &settings);
...
public:
	...
	const	BRect&				GetScaledPrintableRect() const;
			void				SetScaledPrintableRect(
									const BRect& printableRect);
