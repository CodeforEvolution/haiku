...
extern void close_fd(struct io_context *context, struct file_descriptor *descriptor);
...
extern bool fd_close_on_fork(struct io_context *context, int fd);
extern void fd_set_close_on_fork(struct io_context *context, int fd, bool closeFD);
